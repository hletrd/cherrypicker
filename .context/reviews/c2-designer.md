...
### C2-UX01: FileDropzone bank selector does not show which bank was auto-detected (re-confirmed from C1-UX01)
...
### C2-UX02: No loading skeleton for card detail page (re-confirmed from C1-UX02)
...
0 net-new UI/UX findings. 2 re-confirmations of known items.
