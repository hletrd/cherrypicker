...
{:else if opt}
  ...
  <div class="grid gap-5 md:grid-cols-3">
    ...
    <div class="rounded-xl border border-green-200 bg-gradient-to-br from-green-50 to-emerald-100 p-5 dark:from-green-950 dark:to-emerald-900/50">
      ...
      <div class="text-3xl font-bold text-green-700 dark:text-green-400">{opt.savingsVsSingleCard >= 0 && displayedSavings >= 100 ? '+' : ''}{formatWon(displayedSavings < 0 ? Math.abs(displayedSavings) : displayedSavings)}</div>
