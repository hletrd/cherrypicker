...
export const HEADER_KEYWORDS: readonly string[] = [
  ...
  '이용처', '가맹점', '가맹점명', '이용가맹점', '승인가맹점', '거래처', '매출처', '사용처', '결제처', '상호', '판매처', '구매처', '매장', '취급처', '이용내용', '거래내용', '이용업소', '승인점', '매장명', '이용매장', '상호명', '업체명', '판매자', '가맹점상호', '거래내역', '이용가맹점명', '상점', '판매점', '이용매장명', '구매내용', '가게',
  ...
  '업종', '카테고리', '분류', '업종분류', '업종명', '거래유형', '결제유형', '결제구분', '이용구분', '구분', '가맹점유형', '매장유형', '카드종류', '카드구분',
  'date', 'merchant', 'amount', 'total', 'store', 'shop', 'price', 'won', 'description', 'vendor', 'item', 'name', 'charge', 'payment', 'posted', 'billing', 'payee', 'memo', 'note', 'remarks', 'seller', 'company', 'business', 'purchasedate', 'orderdate', 'totalamount', 'transactionamount', 'paymentamount', 'billedamount', 'paid', 'spent', 'cost', 'value', 'approvalno', 'debit', 'credit', 'net', 'netamount', 'gross', 'recipient', 'outlet', 'bookdate', 'canceldate', 'refunddate', 'settlementdate', 'transactiondate', 'statementdate', 'paymentdate', 'invoicedate', 'timestamp', 'supplier', 'brand', 'location', 'category', 'type', 'paymenttype', 'txn', 'txndate', 'txndt', 'txn_date', 'transdate', 'transdt', 'trans_date', 'transactiondt', 'transaction_dt', 'purchasedt', 'purchase_dt', 'desc', 'amt',
];
...
export const CATEGORY_KEYWORDS: ReadonlySet<string> = new Set(['업종', '카테고리', '분류', '업종분류', '업종명', '거래유형', '결제유형', '결제구분', '이용구분', '구분', '가맹점유형', '매장유형', '카드종류', '카드구분', 'category', 'type', 'paymenttype']);
