...
export const MERCHANT_COLUMN_PATTERN = /이용처|가맹점|가맹점명|이용가맹점|승인가맹점|거래처|매출처|사용처|결제처|상호|판매처|구매처|매장|취급처|이용내용|거래내용|이용업소|승인점|매장명|이용매장|상호명|업체명|판매자|가맹점상호|거래내역|이용가맹점명|상점|판매점|이용매장명|구매내용|취소가맹점|^merchant$|^store$|^shop$|^vendor$|^description$|^item$|^name$|^payee$|^seller$|^company$|^business$|^가게$|^recipient$|^outlet$|^supplier$|^brand$|^location$|^details$|^reference$|^transaction$/i;
...
export const MEMO_COLUMN_PATTERN = /비고|적요|메모|내용|설명|참고|참고사항|상세내역|비고란|메모란|상세|비고내용|비고내역|메모내용|메모사항|승인번호|카드번호|승인내역|비고사항|카드명|이용카드|기타|^memo$|^note$|^remarks?$|^approval[\s_-]?(?:no|num|number)$|^details$|^reference$/i;
...
export const MERCHANT_KEYWORDS: ReadonlySet<string> = new Set(['이용처', '가맹점', '가맹점명', '이용가맹점', '승인가맹점', '거래처', '매출처', '사용처', '결제처', '상호', '판매처', '구매처', '매장', '취급처', '이용내용', '거래내용', '이용업소', '승인점', '매장명', '이용매장', '상호명', '업체명', '판매자', '가맹점상호', '거래내역', '이용가맹점명', '상점', '판매점', '이용매장명', '구매내용', '가게', '취소가맹점', 'merchant', 'store', 'shop', 'description', 'vendor', 'item', 'name', 'payee', 'seller', 'company', 'business', 'recipient', 'outlet', 'supplier', 'brand', 'location', 'details', 'reference', 'transaction']);
...
export const MEMO_KEYWORDS: ReadonlySet<string> = new Set(['비고', '적요', '메모', '내용', '설명', '참고', '참고사항', '상세내역', '비고란', '메모란', '상세', '비고내용', '비고내역', '메모내용', '메모사항', '승인번호', '카드번호', '승인내역', '비고사항', '카드명', '이용카드', '기타', 'memo', 'note', 'remarks', 'approvalno', 'details', 'reference']);
