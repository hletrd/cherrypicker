...
## Tech Stack
- **Astro 7 + Svelte 5** — Web app (apps/web/, built and run through Bun scripts)
...
- `apps/web/` — Astro 7 + Svelte 5 static web app. Browser parsing uses the custom TypeScript parsers, SheetJS, and pdfjs-dist; builds through Bun.
