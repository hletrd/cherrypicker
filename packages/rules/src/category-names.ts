 ...
 *
 *  NOTE: This function is not yet wired into consumers. The
 *  FALLBACK_CATEGORY_LABELS in category-labels.ts must be kept in sync
 *  with the taxonomy until integration is complete (C2-01/C3-01). */
