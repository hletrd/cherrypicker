...
export const DATE_COLUMN_PATTERN = /이용일|이용일자|거래일|거래일시|날짜|일시|결제일|승인일|승인일자|승인일시|매출일|작성일|접수일|발행일|사용일|사용일자|조회일|처리일|승인완료일|입금일|주문일|결제예정일|작성일시|승인시간|매입일|전표일|이용시간|^date$|^trans(?:action)?[\s_-]?date$|^purchase[\s_-]?date$|^order[\s_-]?date$|^posted$|^billing$|^book(?:ing)?[\s_-]?date$/i;
...
export const HEADER_KEYWORDS: readonly string[] = [
  '이용일', '이용일자', '거래일', '거래일시', '날짜', '일시', '결제일', '승인일', '승인일자', '승인일시', '매출일', '작성일', '접수일', '발행일', '사용일', '사용일자', '조회일', '처리일', '승인완료일', '입금일', '주문일', '결제예정일', '작성일시', '승인시간', '매입일', '전표일', '이용시간',
  ...
  'date', 'merchant', 'amount', 'total', 'store', 'shop', 'price', 'won', 'description', 'vendor', 'item', 'name', 'charge', 'payment', 'posted', 'billing', 'payee', 'memo', 'note', 'remarks', 'seller', 'company', 'business', 'purchase_date', 'order_date', 'total_amount', 'paid', 'spent', 'cost', 'value', 'approval_no', 'debit', 'credit', 'net', 'recipient', 'outlet', 'book_date',
];
...
export const DATE_KEYWORDS: ReadonlySet<string> = new Set(['이용일', '이용일자', '거래일', '거래일시', '날짜', '일시', '결제일', '승인일', '승인일자', '승인일시', '매출일', '작성일', '접수일', '발행일', '사용일', '사용일자', '조회일', '처리일', '승인완료일', '입금일', '주문일', '결제예정일', '작성일시', '승인시간', '매입일', '전표일', '이용시간', 'date', 'posted', 'billing', 'purchase_date', 'order_date', 'book_date']);
