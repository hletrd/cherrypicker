...
export {
  ...
  type WorkbookSheetMetadataTotals,
  type ResolvedSheetCell,
  type SheetMergeIndex,
  type SheetMergeSpan,
  type SheetPoint,
  type SheetRange,
  type WorksheetMetadataRejectionReason,
  type WorksheetMetadataSheet,
  type WorksheetMetadataTotals,
  type WorksheetMetadataWorkbook,
